    ...
    if(empty($new_password_err) && empty($confirm_password_err)){
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                echo "Oops! Something went wrong, admiral. Please try again later.";
            }
...
<body>
    <div class="wrapper">
        ...
        <p>Please admiral fill out this form to reset your password.</p>
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div>
                <input type="submit" class="buttonBlue" value="Submit">
